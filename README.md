...
* For visualization, I am using D3 to display the sentiment value of each state by conveying it in a color, appropriate to the sentiment value. Color of the State moves from Red to green, as the sentiment value decreases. 
...
* Launch a browser [preferably Google Chrome] and point to [localhost](http://localhost:8000)
